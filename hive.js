...
bot.direction = function(game) {
    ...
    //Find flower with the most pollen.
    ...
    // Find how many steps away my hive is this turn.
    ...
    //If my bee has more than 200 pollen head to hive.
  if (game.myBot.pollen >= 200) {
        task = "myBase";
    }
    // If the game is about to end head to hive.
